  ...
  return (
    <div className="App">
      ...
      <div className='aboutUs' id='aboutUs'>
        ...
        <div className='aboutUsDesc'>Complete Dental Solutions is located at Puthiyara, in the heart of Calicut city and has been providing top-quality dental care for the past 15 years. We pride ourselves on using the best in class technology to provide complete dental solutions for our patients.
Our team of experienced professionals are dedicated to keeping up with the latest advancements in dentistry to ensure that our patients receive the most effective and comfortable treatments available. We are committed to ensuring exceptional care and service to each and every one of our patients.
            </div>
      </div>
